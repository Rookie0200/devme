        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold">CommitLytics</h3>
            </div>
            <p className="text-muted-foreground mb-4 max-w-xs">
              Simplifying developer collaboration through AI-powered documentation, search, and insights.
            </p>
            <div className="flex gap-4">
              <div className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center hover:bg-primary/20 cursor-pointer transition-colors">
